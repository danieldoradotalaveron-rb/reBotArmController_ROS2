...
> **`main` tracks [Seeed upstream](https://github.com/Seeed-Projects/reBotArmController_ROS2)** (MoveIt, gripper, URDF, latest SDK fixes).
> Fork development—safe park, monitor, Cartesian teleop, CI—lives on
...
Clone the **devel branch** for fork features (submodules, `just`, overlays):
...
Details, teleop workflow, and tests → [`CONTRIBUTOR_README.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/CONTRIBUTOR_README.md).
...
Full rationale and file pointers → [`FORK_CHANGES.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/FORK_CHANGES.md).  
Commit history → [`CHANGELOG.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/CHANGELOG.md).
...
|-----|------------------------|
| [`CONTRIBUTOR_README.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/CONTRIBUTOR_README.md) | Build, run, test, submodule layout |
| [`FORK_CHANGES.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/FORK_CHANGES.md) | Understand *why* each fork feature exists |
| [`CHANGELOG.md`](https://github.com/danieldoradotalaveron-rb/reBotArmController_ROS2/blob/devel/based-on-upstream-d3a415e/CHANGELOG.md) | Trace changes commit-by-commit |
| [Seeed upstream README](https://github.com/Seeed-Projects/reBotArmController_ROS2/blob/main/README.md) | Original driver usage on this `main` branch (MoveIt, gripper) |
